...
int main() {
    ...
    for (const auto& s : originalLines)
        outFile << s << '\n';
    outFile << '\n';
    ...
    for (const auto& s : filteredLines)
        outFile << s << '\n';
    outFile << '\n';
    ...
    for (const auto& s : modifiedLines)
        outFile << s << '\n';
    outFile << '\n';
    ...
    auto foundIt = std::find_if(modifiedLines.begin(), modifiedLines.end(), containsWord);
